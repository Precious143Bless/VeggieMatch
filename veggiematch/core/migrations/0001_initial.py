    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surplus_level',  models.CharField(
                ...
                ('status',         models.CharField(
                    choices=[('ACTIVE','Active'),('BOUGHT','Bought'),('RESCUE','Available for Rescue')],
        ...
        migrations.AddIndex(
            model_name='vegetablepost',
            index=models.Index(fields=['status'],       name='idx_post_status'),
        ),
        migrations.AddIndex(
            model_name='vegetablepost',
            index=models.Index(fields=['expiry_time'],  name='idx_post_expiry'),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose',      models.CharField(
                    choices=[('POST','Post'),('BUY','Buy'),('RESCUE','Rescue')],
                    max_length=10,
                )),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['phone_number', 'purpose'], name='idx_otp_phone_purpose'),
        ),
    ]
